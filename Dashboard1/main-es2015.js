...
let SearchHighlightPipe = class SearchHighlightPipe {
...
let AlbumComponent = class AlbumComponent {
    constructor(albumService, componentTitleService) {
    ...
    ngOnInit() {
        this.albumService.httpGetAlbum().subscribe(res => {
            this.albumData = res;
            this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](this.albumData);
...
let ApiComponent = class ApiComponent {
    constructor(_service, componentTitleService) {
...
class UserDataSource extends _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_3__["DataSource"] {
...
let CardComponent = class CardComponent {
    constructor(componentTitleService, titleService) {
        this.componentTitleService = componentTitleService;
...
let DashboardComponent = class DashboardComponent {
    constructor(titleService, meta, componentTitleService) {
        this.titleService = titleService;
        this.meta = meta;
        this.componentTitleService = componentTitleService;
...
let FormsComponent = class FormsComponent {
    constructor(dialog, fb, componentTitleService, titleService) {
        this.dialog = dialog;
        this.fb = fb;
        this.componentTitleService = componentTitleService;
        this.titleService = titleService;
...
let MakePaymentComponent = class MakePaymentComponent {
    constructor(fb, componentTitleService, titleService) {
        this.fb = fb;
        this.componentTitleService = componentTitleService;
        this.titleService = titleService;
...
let NavigationComponent = class NavigationComponent {
    constructor(breakpointObserver, title, cartService) {
...
PaypalComponent.ctorParameters = () => [
    { type: src_app_Services_title_service__WEBPACK_IMPORTED_MODULE_2__["TitleService"] },
    { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["Title"] }
];
...
let ShoppingComponent = class ShoppingComponent {
    constructor(componentTitleService, cartService, titleService) {
        this.componentTitleService = componentTitleService;
        this.cartService = cartService;
        this.titleService = titleService;
        this.cartCounter = 0;
